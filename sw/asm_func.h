...
void mult(uint32_t *a, uint32_t *b, uint32_t *t, uint32_t size);

void reduct(uint32_t *a,uint32_t *b, uint32_t *n, uint32_t *n_prime, uint32_t *t, uint32_t size);

void condsub(uint32_t *t, uint32_t *n, uint32_t size);

void arr_copy(uint32_t *a, uint32_t *b);
